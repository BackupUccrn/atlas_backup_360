...
var M = class extends p(e(c3(c2(l(l2(t(f(b2(j(S(f3))))))))))) {
  ...
  async applyEdits(e2, t2) {
    const { applyEdits: r2 } = await import("./editingSupport-L7MQVDYQ.js");
    await this.load();
