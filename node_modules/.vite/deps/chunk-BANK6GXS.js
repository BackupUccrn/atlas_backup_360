...
var g2 = class extends d {
  ...
  async _queryBuddy(e) {
    var _a;
    const t = new (await import("./FeatureLayer-K4I6BQKX.js")).default({ url: e }), { capabilities: r3 } = await t.load(), i = r3.query.supportsMaxRecordCountFactor, o4 = r3.query.supportsPagination, s2 = r3.query.supportsCentroid, n3 = this._config.maxRecordCountFactor, a3 = t.capabilities.query.maxRecordCount, l = i ? a3 * n3 : a3, h3 = new b();
...
//# sourceMappingURL=chunk-BANK6GXS.js.map
