...
var E = class _E {
  static createIndex(t, e, i2) {
    return new _E(t, A.ELEMENT_ARRAY_BUFFER, e, i2);
  }
  static createVertex(t, e, i2) {
    return new _E(t, A.ARRAY_BUFFER, e, i2);
  }
  static createUniform(t, e, i2) {
    return new _E(t, A.UNIFORM_BUFFER, e, i2);
  }
  static createPixelPack(t, e = F.STREAM_READ, i2) {
    const s = new _E(t, A.PIXEL_PACK_BUFFER, e);
    return i2 && s.setSize(i2), s;
  }
  static createPixelUnpack(t, e = F.STREAM_DRAW, i2) {
    return new _E(t, A.PIXEL_UNPACK_BUFFER, e, i2);
  }
  static createTransformFeedback(t, e = F.STATIC_DRAW, i2) {
    const s = new _E(t, A.TRANSFORM_FEEDBACK_BUFFER, e);
    return s.setSize(i2), s;
  }
  constructor(t, e, i2, s) {
    this._context = t, this.bufferType = e, this.usage = i2, this._glName = null, this._size = -1, this._indexType = void 0, t.instanceCounter.increment(V.BufferObject, this), this._glName = this._context.gl.createBuffer(), u2(this._context.gl), s && this.setData(s);
  }
  get glName() {
    return this._glName;
  }
  ...
  setData(t) {
    if (!t) return;
    let e = t.byteLength;
    this.bufferType === A.ELEMENT_ARRAY_BUFFER && (u(t) ? this._indexType = C.UNSIGNED_BYTE : i(t) ? (e /= 2, this._indexType = C.UNSIGNED_SHORT) : f(t) && (e /= 4, this._indexType = C.UNSIGNED_INT)), this._setBufferData(e, t);
  }
  _setBufferData(t, e = null) {
    ...
    null != e ? s.bufferData(this.bufferType, e, this.usage) : s.bufferData(this.bufferType, t, this.usage), u2(s), this._isVAOAware && this._context.bindVAO(i2);
  }
  setSubData(t, e, i2, s) {
    if (!t) return;
    ...
    _.bufferSubData(this.bufferType, e * t.BYTES_PER_ELEMENT, t, i2, s - i2), u2(_), this._isVAOAware && this._context.bindVAO(r);
  }
  getSubData(t, e = 0, i2, s) {
    if (i2 < 0 || s < 0) return;
    const r = o(t) ? t.BYTES_PER_ELEMENT : 1;
    if (r * ((i2 ?? 0) + (s ?? 0)) > t.byteLength) return;
    e + r * (s ?? 0) > this.usedMemory && h().warn("Potential problem getting subdata: requested data exceeds buffer size!");
    const n2 = this._context.gl;
    this.bufferType === A.TRANSFORM_FEEDBACK_BUFFER ? (this._context.bindBuffer(this, A.TRANSFORM_FEEDBACK_BUFFER), n2.getBufferSubData(A.TRANSFORM_FEEDBACK_BUFFER, e, t, i2, s), this._context.unbindBuffer(A.TRANSFORM_FEEDBACK_BUFFER)) : (this._context.bindBuffer(this, A.COPY_READ_BUFFER), n2.getBufferSubData(A.COPY_READ_BUFFER, e, t, i2, s), this._context.unbindBuffer(A.COPY_READ_BUFFER));
  }
  async getSubDataAsync(t, e = 0, i2, s) {
    await this._context.clientWaitAsync(), this.getSubData(t, e, i2, s);
  }
};
function o(e) {
  return d(e);
...
//# sourceMappingURL=chunk-5MGXRAEC.js.map
