...
var c = class extends b {
  ...
  async update(t, r2) {
    const { addOrUpdateResources: e2 } = await import("./resourceUtils-R623PCKL.js");
...
var k = v = class extends u(m2) {
  ...
  async fetchResources(e2 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-R623PCKL.js");
    return i(this, e2, t);
  }
  async addResource(e2, t, i) {
    const { addOrUpdateResources: r2 } = await import("./resourceUtils-R623PCKL.js");
  ...
  async removeResource(e2, t) {
    const { removeResource: r2 } = await import("./resourceUtils-R623PCKL.js");
  ...
  async removeAllResources(e2) {
    const { removeAllResources: t } = await import("./resourceUtils-R623PCKL.js");
    return t(this, e2);
  }
  resourceFromPath(e2) {
...
//# sourceMappingURL=chunk-MO7UEY4Z.js.map
