...
async function p(e4) {
  ...
  let l3;
  const [{ projectBuffer: u2 }, { initializeProjection: m2 }] = await Promise.all([import("./projectBuffer-5HO7MOH5.js"), import("./projection-KFYBQC7L.js")]);
  await m2(f2, c3);
  const y2 = [0, 0, 0];
  ...
  if ("georeferenced" === a4.type && null == a4.origin) {
    ...
    const e5 = "georeferenced" === a4.type ? a.fromJSON(a4) : a2.fromJSON(a4), { projectMeshVertexPositions: t } = await import("./projectMeshVertexPositions-64IRWFZU.js"), s2 = t({ vertexAttributes: { position: i2 }, transform: n4 ? { localMatrix: n4 } : void 0, vertexSpace: e5, spatialReference: f2 }, c3);
...
//# sourceMappingURL=SceneLayerWorker-TNBXAA75.js.map
