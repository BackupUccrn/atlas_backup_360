...
async function r2(l2, e, o2) {
  ...
  return (await Promise.all(a2.map(async (o3, n2) => ({ value: o3, color: "opacity" === l2.type ? await t(o3, l2, e) : (await import("./visualVariableUtils-Q3QOT3VN.js")).getColor(l2, o3), label: r3 ? u2[n2] : (c == null ? void 0 : c[n2]) ?? "" })))).reverse();
}
async function t(e, n2, r3) {
  const t2 = new l(r3 ?? o), a2 = (await import("./visualVariableUtils-Q3QOT3VN.js")).getOpacity(n2, e);
...
//# sourceMappingURL=chunk-GERHR3YE.js.map
