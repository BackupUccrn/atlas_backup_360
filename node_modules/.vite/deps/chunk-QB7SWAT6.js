...
async function i(e, r2, n2 = false) {
  ...
  if (o4) {
    for (const [s2, i2] of o4) if (i2.name === r2) {
      ...
      if (!e2 && n2) {
        const [{ deleteForwardEdits: e3 }, { default: r3 }] = await Promise.all([import("./deleteForwardEdits-646LTCSE.js"), import("./DeleteForwardEditsParameters-LGHDJLHR.js")]), n3 = await e3(a4, s2, new r3({ sessionId: t, moment: i2.moment }));
...
//# sourceMappingURL=chunk-QB7SWAT6.js.map
