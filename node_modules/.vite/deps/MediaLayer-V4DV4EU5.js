import {
  ...
  m as m4,
  p as p4
} from "./chunk-5PIORWY5.js";
import "./chunk-5KT47T3C.js";
import {
  p as p3
} from "./chunk-F5UDIHKR.js";
import {
  o as o4
...
var E3 = class extends l(t(b(j2(S2(f2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = k(async (e4, r4, o6) => {
      const { save: t3, saveAs: s6 } = await import("./mediaLayerUtils-2X64IUU4.js");
      switch (e4) {
        case A.SAVE:
          return t3(this, r4);
        case A.SAVE_AS:
...
//# sourceMappingURL=MediaLayer-V4DV4EU5.js.map
