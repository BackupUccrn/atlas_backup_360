...
var x = _ = class extends u2(m2) {
  ...
  async _loadLayersFromJSON(e, r3, t2) {
    var _a, _b;
    const s3 = (_a = this.resourceInfo) == null ? void 0 : _a.context, a4 = ((_b = this.portalItem) == null ? void 0 : _b.portal) || (s3 == null ? void 0 : s3.portal) || null, o = U2[(s3 == null ? void 0 : s3.origin) || ""] ?? "web-map", { populateOperationalLayers: i2 } = await import("./layersCreator-BDLON4FK.js"), n4 = [];
...
//# sourceMappingURL=chunk-XXHAPQT6.js.map
