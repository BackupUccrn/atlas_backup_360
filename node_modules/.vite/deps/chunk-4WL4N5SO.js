...
import {
  D,
  R as R2
} from "./chunk-JLU2PIGW.js";
import {
  f as f3,
  i as i4,
  s as s4
} from "./chunk-NYKL7NZO.js";
import {
  d as d3
} from "./chunk-ZACJNPPN.js";
import {
  p as p5
} from "./chunk-TEU7V4ZZ.js";
import {
  y
} from "./chunk-3SMD4CKG.js";
import {
  A,
  n as n5
} from "./chunk-MNYRG4K6.js";
import {
  p as p6
} from "./chunk-LVB6V7LJ.js";
import {
  p as p2
...
import {
  a as a5,
  z
} from "./chunk-EQIDZDW7.js";
import {
  a as a4,
  b,
  j as j2,
  v
} from "./chunk-K6LJMNUM.js";
import {
  a as a3,
  m as m2,
  p as p3
} from "./chunk-FKCA2JZM.js";
import {
  a2 as a6
} from "./chunk-UKVTKW36.js";
import {
  T,
  h
} from "./chunk-SWMRE33A.js";
import {
  d as d2
} from "./chunk-EHJPZB74.js";
import {
  n as n4
} from "./chunk-EB5T2ZDF.js";
import {
  S,
  d,
  y as y2
...
import {
  n as n3
} from "./chunk-IEXL2YQC.js";
import {
  f as f2,
  p
} from "./chunk-RIMBCJME.js";
import {
  j2 as j,
  w
...
r([m({ type: String, json: { write: true } })], i7.prototype, "name", void 0), r([m({ type: String, json: { write: true } })], i7.prototype, "description", void 0), r([m({ type: x, json: { type: x, write: true, name: "_object_id" } })], i7.prototype, "id", void 0), r([m({ type: String, json: { type: n8.jsonValues, read: n8.read, write: n8.write } })], i7.prototype, "pixelType", void 0), r([m({ type: String, json: { write: true } })], i7.prototype, "type", void 0), i7 = r([a2("esri.layers.support.RasterFunctionInfo")], i7);
var n9 = i7;
...
r([m({ type: [String], json: { write: true } })], a11.prototype, "aliases", void 0), r([m({ type: Object, json: { write: true } })], a11.prototype, "arguments", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "description", void 0), r([m({ type: n9, json: { write: true, name: "function" } })], a11.prototype, "functionInfo", void 0), r([m({ type: y3.apiValues, json: { type: [0, 1, 2], read: y3.read, write: y3.write } })], a11.prototype, "functionType", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "group", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "help", void 0), r([m({ type: Number, json: { type: x, write: true, name: "_object_id" } })], a11.prototype, "id", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "name", void 0), r([m({ type: String, json: { write: true, name: "definition" } })], a11.prototype, "queryDefinition", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "tag", void 0), r([m({ type: n10, json: { write: true } })], a11.prototype, "properties", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "thumbnail", void 0), r([m({ type: String, json: { write: true } })], a11.prototype, "thumbnailEx", void 0), r([m({ json: { type: ["RasterFunctionTemplate"], write: true } })], a11.prototype, "type", void 0), a11 = r([a2("esri.layers.support.RasterFunctionTemplate")], a11);
var c = a11;
...
var h2 = (t3) => {
  ...
  t3 = a(t3);
  const n11 = {};
  for (const e2 of Object.keys(t3)) p8.has(e2.toLowerCase()) ? n11[e2] = f5(t3[e2]) : m5.has(e2.toLowerCase()) && Array.isArray(t3[e2]) ? n11[e2] = t3[e2].map(f5) : n11[e2] = t3[e2];
  return n11;
};
...
var d4 = c2 = class extends f {
  ...
  set functionArguments(t3) {
    if (t3) {
      const n11 = Object.keys(t3);
      if (n11.some((n12) => p8.has(n12.toLowerCase()) && y4(t3[n12])) || n11.some((n12) => m5.has(n12.toLowerCase()) && Array.isArray(t3[n12]) && t3[n12].some((t4) => y4(t4)))) {
        t3 = a(t3);
        for (const e2 of n11) p8.has(e2.toLowerCase()) ? t3[e2] = F(t3[e2]) : m5.has(e2.toLowerCase()) && Array.isArray(t3[e2]) && (t3[e2] = t3[e2].map((t4) => F(t4)));
      }
    }
  ...
  writeFunctionArguments(t3, n11, e2) {
    const r5 = {};
  ...
  readFunctionName(t3, n11) {
    var _a;
    const e2 = n11.rasterFunctionInfos, r5 = n11.name;
    return r5 || ((e2 == null ? void 0 : e2.length) && "None" !== e2[0].name ? e2[0].name : n11.rasterFunction || ((_a = n11.rasterFunctionDefinition) == null ? void 0 : _a.name));
  }
...
var h3 = d5 = class extends v(f) {
  ...
  clone() {
    var _a, _b;
    const { density: o5, maxPathLength: t3, trailWidth: e2, flowSpeed: r5, trailLength: i10, smoothing: s6, flowRepresentation: n11, trailCap: p12, background: a14 } = this, l7 = this.color.clone(), m10 = (this.visualVariables || []).map((o6) => o6.clone()), c10 = (_a = this.authoringInfo) == null ? void 0 : _a.clone(), h6 = (_b = this.legendOptions) == null ? void 0 : _b.clone();
    return new d5({ density: o5, color: l7, maxPathLength: t3, trailWidth: e2, flowSpeed: r5, trailLength: i10, trailCap: p12, background: a14, smoothing: s6, flowRepresentation: n11, visualVariables: m10, authoringInfo: c10, legendOptions: h6 });
  }
  getSymbol(o5, t3) {
  }
...
var b2 = S2 = class extends v(f) {
  ...
  async getGraphicsFromPixelData(e2, M2 = false, t3 = []) {
    ...
    for (let l7 = 0; l7 < g6.height; l7++) for (let e3 = 0; e3 < g6.width; e3++, d10++) {
      let M3 = new j({ x: o5.xmin + e3 * D2 + D2 / 2, y: o5.ymax - l7 * w3 - w3 / 2, spatialReference: o5.spatialReference });
      M3 = (await R(M3))[0];
...
var t2 = class {
  ...
  async convertVectorFieldData(r5, t3) {
    ...
    const n11 = await this._workerThread.invoke("convertVectorFieldData", { pixelBlock: r5.pixelBlock.toJSON(), type: r5.dataType }, t3);
    return n11 ? new g2(n11) : null;
  }
  ...
  async decode(r5, t3) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    const n11 = await this._workerThread.invoke("decode", r5, t3);
    return n11 ? new g2(n11) : null;
  }
  async symbolize(r5, t3) {
    var _a, _b;
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    const n11 = { extent: (_a = r5.extent) == null ? void 0 : _a.toJSON(), pixelBlock: (_b = r5.pixelBlock) == null ? void 0 : _b.toJSON(), simpleStretchParams: r5.simpleStretchParams, bandIds: r5.bandIds }, a14 = await this._workerThread.invoke("symbolize", n11, t3);
  ...
  async process(r5, t3) {
    var _a, _b;
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    const n11 = await this._workerThread.invoke("process", { extent: (_a = r5.extent) == null ? void 0 : _a.toJSON(), primaryPixelSizes: (_b = r5.primaryPixelSizes) == null ? void 0 : _b.map((e2) => null != e2 ? e2.toJSON() : null), primaryPixelBlocks: r5.primaryPixelBlocks.map((e2) => null != e2 ? e2.toJSON() : null), primaryRasterIds: r5.primaryRasterIds }, t3);
    return n11 ? new g2(n11) : null;
  }
  async stretch(r5, t3) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    if (!(r5 == null ? void 0 : r5.pixelBlock)) return null;
    const n11 = { srcPixelBlock: r5.pixelBlock.toJSON(), stretchParams: r5.stretchParams }, a14 = await this._workerThread.invoke("stretch", n11, t3);
    return a14 ? new g2(a14) : null;
  }
  async split(r5, t3) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    if (!(r5 == null ? void 0 : r5.pixelBlock)) return null;
    const n11 = { srcPixelBlock: r5.pixelBlock.toJSON(), tileSize: r5.tileSize, maximumPyramidLevel: r5.maximumPyramidLevel, useBilinear: r5.useBilinear }, a14 = await this._workerThread.invoke("split", n11, t3);
  ...
  async clipTile(r5, t3) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    if (!(r5 == null ? void 0 : r5.pixelBlock)) return null;
    const n11 = { ...r5, pixelBlock: r5.pixelBlock.toJSON() }, a14 = await this._workerThread.invoke("clipTile", n11, t3);
  ...
  async mosaicAndTransform(r5, t3) {
    ...
    const n11 = { ...r5, srcPixelBlocks: r5.srcPixelBlocks.map((e2) => null != e2 ? e2.toJSON() : null) }, a14 = await this._workerThread.invoke("mosaicAndTransform", n11, t3);
  ...
  async createFlowMesh(r5, o5) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    const t3 = { buffer: r5.flowData.data.buffer, maskBuffer: r5.flowData.mask.buffer, width: r5.flowData.width, height: r5.flowData.height }, { meshType: n11, simulationSettings: a14 } = r5, i10 = await this._workerThread.invoke("createFlowMesh", { meshType: n11, flowData: t3, simulationSettings: a14 }, { ...o5, transferList: [t3.buffer, t3.maskBuffer] });
  ...
  getProjectionOffsetGrid(r5, o5) {
    if (!this._workerThread) throw new s("raster-jobhandler:no-connection", "no available worker connection");
    const t3 = null != r5.datumTransformation ? r5.datumTransformation.steps.map((e2) => ({ wkid: e2.wkid, wkt: e2.wkt, isInverse: e2.isInverse })) : null, n11 = null != r5.rasterTransform ? r5.rasterTransform.toJSON() : null, a14 = { projectedExtent: r5.projectedExtent.toJSON(), srcBufferExtent: r5.srcBufferExtent.toJSON(), pixelSize: r5.pixelSize, hasWrapAround: r5.hasWrapAround, spacing: r5.spacing, datumTransformationSteps: t3, rasterTransform: n11, isAdaptive: r5.isAdaptive, includeGCSGrid: r5.includeGCSGrid };
...
function L(e2) {
  var _a;
  return (_a = e2.presetRenderers) == null ? void 0 : _a.find(({ method: t3, value: n11 }) => "raster-function-template" === t3 ? n11 === e2.rasterFunctionName : "variable" === t3 && n11 === e2.variableName);
}
function q(e2, t3) {
  const { attributeTable: n11, colormap: a14 } = e2;
  if (o3(e2)) {
    const t4 = Z2(e2);
  ...
  if (t3 == null ? void 0 : t3.rasterFunctionColorRamp) {
    const n12 = N2(e2, t3);
    return n12.colorRamp = t3.rasterFunctionColorRamp, n12;
  }
  if (null != a14) {
    const t4 = H(e2);
    if (null != t4) return t4;
...
function B2(e2, t3 = false) {
  const n11 = ["raster-stretch"];
  return u(e2, t3) && n11.push("raster-colormap"), t(e2) && n11.push("unique-value"), r4(e2, t3) && n11.push("class-breaks"), e(e2) && n11.push("raster-shaded-relief"), o3(e2) && n11.push("vector-field"), i5(e2) && n11.push("flow"), n11;
}
function E(e2) {
  return "Function" === e2.datasetFormat && "Colormap" === e2.rasterFunction.functionName ? e2.rasterFunction.colorRamp : void 0;
}
function z4(e2, t3, n11) {
  const a14 = ["nearest", "bilinear", "cubic", "majority"], r5 = n11 == null ? void 0 : n11.toLowerCase().replace("bicubic", "cubic"), l7 = a14.find((e3) => e3 === r5);
  if ("Map" === t3) return l7 ?? "bilinear";
...
function N2(e2, t3) {
  ...
  const { bandCount: n11 } = e2;
  let { bandIds: a14, stretchType: r5 } = t3 || {};
  (a14 == null ? void 0 : a14.some((e3) => e3 >= n11)) && (a14 = null);
  let l7 = e2.statistics, s6 = e2.histograms;
  n11 > 1 ? (a14 = (a14 == null ? void 0 : a14.length) ? a14 : U2(e2), l7 = null == l7 ? null : a14 == null ? void 0 : a14.map((e3) => l7[e3]), s6 = null == s6 ? null : a14 == null ? void 0 : a14.map((e3) => s6[e3])) : a14 = [0], null == r5 && (r5 = A2(e2)), (t3 == null ? void 0 : t3.includeStatisticsInStretch) && ("percent-clip" === r5 || "histogram-equalization" === r5) && ((_a = e2.statistics) == null ? void 0 : _a.length) && (r5 = "min-max");
  let i10 = false;
  switch (r5) {
    case "none":
      i10 = false;
    ...
    case "percent-clip":
      ...
      break;
    default:
      i10 = !(l7 == null ? void 0 : l7.length);
  }
  const { dataType: o5 } = e2, u5 = 1 === (a14 == null ? void 0 : a14.length) && F2.has(o5) ? S3 : null, m10 = new g4({ stretchType: r5, dynamicRangeAdjustment: i10, colorRamp: u5, outputMin: 0, outputMax: 255, gamma: 1 === (a14 == null ? void 0 : a14.length) ? [1] : [1, 1, 1], useGamma: false });
  return "percent-clip" === r5 ? m10.maxPercent = m10.minPercent = I : "standard-deviation" === r5 && (m10.numberOfStandardDeviations = 2), i10 || null == e2.multidimensionalInfo && !(t3 == null ? void 0 : t3.includeStatisticsInStretch) || ("percent-clip" === r5 ? m10.histograms = s6 : "min-max" !== r5 && "standard-deviation" !== r5 || (m10.statistics = l7)), m10;
}
function W(e2, t3) {
  const { multidimensionalInfo: n11 } = e2;
  if (!t3 || !n11) return e2;
  const a14 = n11.variables.find((e3) => e3.name === t3);
  if (!a14) return e2;
  if (e2 = e2.clone(), a14) {
    const { statistics: t4, histograms: n12 } = a14;
    (t4 == null ? void 0 : t4.length) && (e2.statistics = t4.map((e3) => ({ min: e3.min, max: e3.max, avg: e3.avg, stddev: e3.stddev }))), (n12 == null ? void 0 : n12.length) && (e2.histograms = n12);
  }
  return e2;
}
function U2(e2) {
  ...
  if (1 === t3) return null;
  if (2 === t3) return [0];
  const { bandInfos: n11 } = e2;
  let a14;
  if (n11.length === t3) {
    const { red: e3, green: t4, blue: r5, nir: l7 } = O(n11);
    null != e3 && null != t4 && null != r5 ? a14 = [e3, t4, r5] : null != l7 && null != e3 && null != t4 && (a14 = [l7, e3, t4]);
  }
  return !a14 && t3 >= 3 && (a14 = [0, 1, 2]), a14;
}
function O(e2) {
  const t3 = {};
  for (let n11 = 0; n11 < e2.length; n11++) {
    const a14 = e2[n11], r5 = a14.name.toLowerCase();
    if ("red" === r5) t3.red = n11;
    else if ("green" === r5) t3.green = n11;
    else if ("blue" === r5) t3.blue = n11;
    else if ("nearinfrared" === r5 || "nearinfrared_1" === r5 || "nir" === r5) t3.nir = n11;
    else if (a14.maxWavelength && a14.minWavelength) {
      const e3 = a14.minWavelength, r6 = a14.maxWavelength;
      null == t3.blue && e3 >= 410 && e3 <= 480 && r6 >= 480 && r6 <= 540 ? t3.blue = n11 : null == t3.green && e3 >= 490 && e3 <= 560 && r6 >= 560 && r6 <= 610 ? t3.green = n11 : null == t3.red && e3 >= 595 && e3 <= 670 && r6 >= 660 && r6 <= 730 ? t3.red = n11 : null == t3.nir && e3 >= 700 && e3 <= 860 && r6 >= 800 && r6 <= 950 && (t3.nir = n11);
    }
  }
  return t3;
}
function A2(e2) {
  let t3 = "percent-clip";
  const { pixelType: n11, dataType: a14, histograms: r5, statistics: l7, multidimensionalInfo: s6 } = e2, i10 = F2.has(a14) || "generic" === a14 && null != s6;
  return "u8" !== n11 || "processed" !== a14 && null != r5 && null != l7 ? "u8" === n11 || "elevation" === a14 || i10 ? t3 = "min-max" : null != r5 ? t3 = "percent-clip" : null != l7 && (t3 = "min-max") : t3 = "none", t3;
}
function J(t3, n11, a14, l7) {
  if (!t(t3, n11)) return null;
  const { attributeTable: s6, statistics: o5 } = t3, u5 = P(s6, n11), c10 = _(s6, "red"), f8 = _(s6, "green"), p12 = _(s6, "blue"), b3 = new j2(), h6 = [], g6 = /* @__PURE__ */ new Set(), v2 = !!(c10 && f8 && p12);
  if (null != s6) s6.features.forEach((t4) => {
    const n12 = t4.attributes[u5.name];
    if (!g6.has(t4.attributes[u5.name]) && null != n12) {
      g6.add(n12);
      const a15 = v2 && ("single" === c10.type || "double" === c10.type) && ("single" === f8.type || "double" === f8.type) && ("single" === p12.type || "double" === p12.type) && !s6.features.some((e2) => e2.attributes[c10.name] > 1 || e2.attributes[f8.name] > 1 || e2.attributes[p12.name] > 1), r5 = a15 ? 255 : 1;
      h6.push(new n5({ value: t4.attributes[u5.name], label: t4.attributes[u5.name] + "", symbol: new S({ style: "solid", outline: null, color: new l(v2 ? [t4.attributes[c10.name] * r5, t4.attributes[f8.name] * r5, t4.attributes[p12.name] * r5, 1] : [0, 0, 0, 0]) }) }));
    }
  });
  else if (o5 == null ? void 0 : o5[0]) for (let r5 = o5[0].min; r5 <= o5[0].max; r5++) h6.push(new n5({ value: r5, label: r5.toString(), symbol: new S({ style: "solid", outline: null, color: new l([0, 0, 0, 0]) }) }));
  if (h6.sort((e2, t4) => e2.value && "string" == typeof e2.value.valueOf() ? 0 : e2.value > t4.value ? 1 : -1), !v2) {
    const t4 = B(k, { numColors: h6.length });
    h6.forEach((n12, a15) => n12.symbol.color = new l(t4[a15].slice(1, 4))), b3.colorRamp = k;
  }
  if (a14 || l7) {
    const t4 = a14 || B(l7, { numColors: h6.length }).map((e2) => e2.slice(1));
    h6.forEach((n12, a15) => n12.symbol.color = new l(t4[a15])), b3.colorRamp = l7;
  }
  return new A({ field: u5.name, uniqueValueInfos: h6, authoringInfo: b3 });
}
...
function G(e2) {
  let t3;
  for (let n11 = 0; n11 < e2.length; n11++) {
    const a14 = e2[n11].name.toLowerCase();
    if ("string" === e2[n11].type) {
      if (a14.startsWith("class")) {
        t3 = e2[n11];
        break;
      }
      null == t3 && (a14.endsWith("name") || a14.endsWith("type")) && (t3 = e2[n11]);
    }
  }
  return t3;
}
...
function H(e2) {
  ...
  const { attributeTable: n11, colormap: a14 } = e2;
  if (null != n11) {
    const e3 = _(n11, "value"), a15 = P(n11, null, true);
    "string" === a15.type && (t3 = {}, n11.features.forEach((n12) => {
      const r5 = n12.attributes;
...
function Z2(e2) {
  ...
  if (null != e2.statistics && e2.statistics.length && ("vector-magdir" === e2.dataType || "vector-uv" === e2.dataType)) {
    const { minMagnitude: n12, maxMagnitude: a15 } = ne(e2.dataType, e2.statistics);
    t3 = [new b({ field: "Magnitude", minSize: 10, maxSize: 40, minDataValue: n12, maxDataValue: a15 })];
  }
  const n11 = null != e2.multidimensionalInfo ? Y.get(e2.multidimensionalInfo.variables[0].unit) : void 0, a14 = new h4({ visualVariables: t3, inputUnit: n11, rotationType: "geographic" });
...
function ee(e2) {
  ...
  if ("uniqueValue" === e2.type) {
    const t3 = e2.uniqueValueInfos, n11 = t3 == null ? void 0 : t3[0].symbol;
    return ((_a = n11 == null ? void 0 : n11.symbolLayers) == null ? void 0 : _a.length) && (e2.uniqueValueInfos = t3 == null ? void 0 : t3.map((e3) => ({ value: e3.value, label: e3.label, symbol: e3.symbol ? $(e3.symbol) : null }))), e2;
  }
  if ("classBreaks" === e2.type) {
    const t3 = e2.classBreakInfos, n11 = t3[0].symbol;
    return ((_b = n11 == null ? void 0 : n11.symbolLayers) == null ? void 0 : _b.length) && (e2.classBreakInfos = t3.map((e3) => ({ classMinValue: e3.classMinValue, classMaxValue: e3.classMaxValue, label: e3.label, symbol: e3.symbol ? $(e3.symbol) : null }))), e2;
  }
  return e2;
}
function ne(e2, t3) {
  let n11, a14;
  if ("vector-magdir" === e2) n11 = t3[0].min, a14 = t3[0].max;
  else {
    const e3 = t3[0].min, r5 = t3[0].max, l7 = t3[1].min, s6 = t3[1].max;
    n11 = 0, a14 = Math.max(Math.abs(e3), Math.abs(l7), Math.abs(r5), Math.abs(s6));
  }
  return { minMagnitude: n11, maxMagnitude: a14 };
}
...
r([m({ types: n3, json: { read: f2 } })], j3.prototype, "geometry", void 0), r([r2("geometry")], j3.prototype, "writeGeometry", null), r([m({ type: f6, json: { write: true } })], j3.prototype, "mosaicRule", void 0), r([m({ type: N, json: { write: true, name: "renderingRule" } })], j3.prototype, "rasterFunction", void 0), r([m({ type: j, json: { write: true } })], j3.prototype, "pixelSize", void 0), r([m({ json: { write: true } })], j3.prototype, "raster", void 0), r([m({ type: p2, json: { read: { source: "time" }, write: { target: "time" } } })], j3.prototype, "timeExtent", void 0), j3 = y7 = r([a2("esri.rest.support.ImageHistogramParameters")], j3);
var g5 = j3;

// node_modules/@arcgis/core/rest/imageService/fetchRasterInfo.js
async function m9(m10, f8, p12) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j;
  const c10 = f3(m10), { rasterFunction: d10, sourceJSON: h6 } = f8 || {}, g6 = d10 ? JSON.stringify(d10.rasterFunctionDefinition || d10) : null, y8 = s4({ ...c10.query, renderingRule: g6, f: "json" }), x2 = i4(y8, p12);
  m10 = c10.path;
  const b3 = h6 || await U(m10, x2).then((e2) => e2.data), v2 = b3.hasRasterAttributeTable ? U(`${m10}/rasterAttributeTable`, x2) : null, S4 = b3.hasColormap ? U(`${m10}/colormap`, x2) : null, V = b3.hasHistograms ? U(`${m10}/histograms`, x2) : null, D2 = b3.currentVersion >= 10.3 ? U(`${m10}/keyProperties`, x2) : null, I2 = b3.hasMultidimensions ? U(`${m10}/multidimensionalInfo`, x2) : null, T2 = await Promise.allSettled([v2, S4, V, D2, I2]);
  let R3 = null;
...
//# sourceMappingURL=chunk-4WL4N5SO.js.map
