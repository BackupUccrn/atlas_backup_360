...
var x2 = class extends b {
  ...
  async featureSetFromJSON(e, t, r2) {
    ...
    const { meshFeatureSetFromJSON: s5 } = await h(import("./meshFeatureSet-COLWZNEE.js"), r2);
  ...
  async executeRelationshipQuery(e, t) {
    const [{ default: r2 }, { executeRelationshipQuery: s5 }] = await h(Promise.all([import("./RelationshipQuery-M6DFKE7C.js"), import("./executeRelationshipQuery-7OAGXI3V.js")]), t);
  ...
  async executeRelationshipQueryForCount(e, t) {
    const [{ default: r2 }, { executeRelationshipQueryForCount: s5 }] = await h(Promise.all([import("./RelationshipQuery-M6DFKE7C.js"), import("./executeRelationshipQuery-7OAGXI3V.js")]), t);
    return e = r2.from(e), (this.gdbVersion || this.dynamicDataSource) && ((e = e.clone()).gdbVersion = e.gdbVersion || this.gdbVersion, e.dynamicDataSource = e.dynamicDataSource || this.dynamicDataSource), s5(this.url, e, t);
  }
  async executeAttachmentQuery(e, t) {
    const { executeAttachmentQuery: r2, fetchAttachments: s5, processAttachmentQueryResult: i2 } = await h(import("./queryAttachments-6KDVML3W.js"), t), u2 = f(this.url);
    return i2(u2, await (this.queryAttachmentsSupported ? r2(u2, e, t) : s5(u2, e, t)));
  }
  async executeBinsQuery(e, t) {
    const { executeBinsQuery: r2 } = await h(import("./executeBinsQuery-2BKTDYIW.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeTopFeaturesQuery(e, t) {
    const { executeTopFeaturesQuery: r2 } = await h(import("./executeTopFeaturesQuery-TL5LLUSZ.js"), t);
    return r2(this.parsedUrl, e, this.sourceSpatialReference, t);
  }
  async executeForTopIds(e, t) {
    const { executeForTopIds: r2 } = await h(import("./executeForTopIds-MQBD4IN5.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopExtents(e, t) {
    const { executeForTopExtents: r2 } = await h(import("./executeForTopExtents-G5MHYM7Q.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  async executeForTopCount(e, t) {
    const { executeForTopCount: r2 } = await h(import("./executeForTopCount-IGEZHTHY.js"), t);
    return r2(this.parsedUrl, e, t);
  }
  _normalizeQuery(e) {
    let t = b2.from(e);
...
//# sourceMappingURL=chunk-ADN7MW54.js.map
