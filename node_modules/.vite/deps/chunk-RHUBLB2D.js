...
import {
  ...
  w as w3,
  z as z3
} from "./chunk-XLE5ESPW.js";
import {
  f as f3
} from "./chunk-G5DBITNY.js";
import {
  p as p2
} from "./chunk-QQPOGGED.js";
import {
  b
...
async function c7(e10, n9, r4) {
  const { source: o3 } = n9, { loadGLTFMesh: i3 } = await h(import("./loadGLTFMesh-TYOA2YZ6.js"), r4), l3 = await f6(o3, r4);
  s2(r4);
...
var X2 = H2 = class extends m2.LoadableMixin(n2(n3)) {
  ...
  async toBinaryGLTF(e10) {
    const [{ toBinaryGLTF: t6 }] = await Promise.all([import("./gltfexport-XLRD54OW.js"), this.load(e10)]);
  ...
  static async createFromGLTF(e10, t6, r4) {
    ...
    const { loadGLTFMesh: o3 } = await h(import("./loadGLTFMesh-TYOA2YZ6.js"), r4);
...
//# sourceMappingURL=chunk-RHUBLB2D.js.map
