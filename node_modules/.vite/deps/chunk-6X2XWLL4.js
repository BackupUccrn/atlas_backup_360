...
async function l3(o2, r7, a2 = {}, l4 = true) {
  ...
  await c4(m2, async (o3, r8, s3, n6) => {
    ...
    const x3 = m2.getPositionData(o3, a2), h2 = m2.getMaterial(o3, a2, l4), w2 = m2.hasNormals(o3) ? m2.getNormalData(o3, a2) : null, v2 = m2.hasTangents(o3) ? m2.getTangentData(o3, a2) : null, S = m2.hasTextureCoordinates(o3) ? m2.getTextureCoordinates(o3, a2) : null, R = m2.hasVertexColors(o3) ? m2.getVertexColors(o3, a2) : null, _2 = m2.getIndexData(o3, a2), E4 = { name: n6, transform: r2(r8), attributes: { position: await x3, normal: w2 ? await w2 : null, texCoord0: S ? await S : null, color: R ? await R : null, tangent: v2 ? await v2 : null }, indices: await _2, primitiveType: f3, material: d2(T, await h2, p2) };
    let I = null;
...
//# sourceMappingURL=chunk-6X2XWLL4.js.map
