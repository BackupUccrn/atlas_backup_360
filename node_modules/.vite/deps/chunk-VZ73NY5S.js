...
var G = class extends m2 {
  ...
  async uploadAssets(e2, t2) {
    const { uploadAssets: r3 } = await import("./uploadAssets-L7MF7GNH.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i3 of t2) {
      ...
      if (a4(t3)) s5.push(e3);
        ...
        const t4 = e3.origin, { convertMeshVertexSpace: r4 } = await import("./convertMeshVertexSpace-CXJDK7BC.js"), n3 = await r4(e3, new a3({ origin: [t4.x, t4.y, t4.z ?? 0] }));
...
//# sourceMappingURL=chunk-VZ73NY5S.js.map
