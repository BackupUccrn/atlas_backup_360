...
import {
  defineCustomElement
} from "./chunk-5F7QCO3I.js";
import {
  focusElement,
  guid,
  toAriaBoolean
} from "./chunk-43FLTS42.js";
import {
  Fragment,
  H,
  createEvent,
...
var ActionMenu = proxyCustomElement(class ActionMenu2 extends H {
  ...
  renderMenuButton() {
    ...
    const menuButtonSlot = h("slot", { name: SLOTS.trigger, onSlotchange: this.setMenuButtonEl }, h("calcite-action", { appearance, class: CSS.defaultTrigger, icon: ICONS.menu, ref: this.setDefaultMenuButtonEl, scale, text: label, textEnabled: expanded }));
...
@esri/calcite-components/dist/components/action-menu.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BOJIBW5S.js.map
