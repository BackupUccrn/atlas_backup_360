import {
  t as t2
} from "./chunk-MCCQ4XVJ.js";
import {
  s as s4,
  s2 as s5
} from "./chunk-7KI4UW5Q.js";
import {
  s as s6
} from "./chunk-TVAWQHMY.js";
import {
  t as t3
} from "./chunk-SQGTZEZ4.js";
import "./chunk-JUZLGA76.js";
import "./chunk-JQEXAS55.js";
import "./chunk-A3GASGJZ.js";
import "./chunk-EY3ITZF4.js";
import "./chunk-3H32QNPP.js";
...
var x3 = class extends l(l3(t(b3(j2(o2(Me(f3(e(l2(S(i2(f8)))))))))))) {
  constructor(...e4) {
    super(...e4), this.isReference = null, this.operationalLayerType = "ArcGISImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.type = "imagery", this._debouncedSaveOperations = k(async (e5, r4, t6) => {
      const { save: s10, saveAs: i11 } = await import("./imageryUtils-FTNWPWS6.js");
      switch (e5) {
        case A.SAVE:
          return s10(this, r4);
        case A.SAVE_AS:
