import {
  ...
  s as s3,
  x as x2
} from "./chunk-C3G3RMSF.js";
import {
  T as T3
} from "./chunk-4XKUH6VW.js";
import {
  T as T2,
  c,
  h as h2,
...
import {
  a as a3,
  u as u2
} from "./chunk-RJQWAMIG.js";
import "./chunk-JLU2PIGW.js";
import "./chunk-7OADJ2IO.js";
...
var m6 = class extends X {
  ...
  async _updateClipGeometry() {
    ...
    if (e3 && "inside" === t5.clippingType) {
      const { extent: t6 } = this.rasterInfo, { difference: r7, densify: s4 } = await import("./geometryEngine-J2PBGQFN.js");
...
var L3 = class extends l2(t(b(j2(o3(e(K2(l5(l4(f2(S(i2(f6)))))))))))) {
  constructor(...e3) {
    super(...e3), this._primaryRasters = [], this.legendEnabled = true, this.isReference = null, this.listMode = "show", this.sourceJSON = null, this.version = null, this.type = "imagery-tile", this.operationalLayerType = "ArcGISTiledImageServiceLayer", this.popupEnabled = true, this.popupTemplate = null, this.fields = null, this.source = void 0, this._debouncedSaveOperations = k(async (e4, t5, r7) => {
      const { save: s4, saveAs: i7 } = await import("./imageryUtils-FTNWPWS6.js");
      switch (e4) {
        case A.SAVE:
          return s4(this, t5);
        case A.SAVE_AS:
...
//# sourceMappingURL=@arcgis_core_layers_ImageryTileLayer__js.js.map
