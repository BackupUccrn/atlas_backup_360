...
import {
  i as i8
} from "./chunk-QCVYWPR5.js";
import {
  a as a5
} from "./chunk-KTRQ2TUI.js";
import {
  i as i7
} from "./chunk-IJYD2OHS.js";
import {
  j,
  y as y2
} from "./chunk-BN7NJFOA.js";
import {
  i as i6,
  n as n5,
  r as r4
} from "./chunk-ZBN6IKGO.js";
import {
  M as M2,
  T as T2,
  a as a7,
  ...
  t6 as t5,
  x as x2
} from "./chunk-HW4RSWWQ.js";
import {
  b as b5
} from "./chunk-P7EWAGFK.js";
import {
  n as n4,
  p as p2
...
import {
  e as e3
} from "./chunk-P53T32JE.js";
import {
  ee,
  me,
  o as o3
} from "./chunk-LQZXJXUS.js";
import {
  tt
} from "./chunk-EFJMDFRY.js";
import {
  E,
  N,
  R,
...
import {
  e as e4
} from "./chunk-LBDY2VEB.js";
import {
  a as a6
} from "./chunk-7DH2NR2W.js";
import {
  o as o4
} from "./chunk-PAS43ZQC.js";
import {
  a as a3
} from "./chunk-MW7G2BY3.js";
import {
  d as d6,
  w as w2
} from "./chunk-JD66DOIA.js";
import {
  a as a4
} from "./chunk-TMCOG7V7.js";
import {
  f as f2
} from "./chunk-YHE45G3E.js";
import {
  b as b3
...
async function l5(a11, l8, r12) {
  const n11 = l8.labelsVisible && l8.labelingInfo || [], i12 = e6(l8), m12 = a4(n11, i12);
...
var l6 = class {
  ...
  async createServiceOptions(o14) {
    var _a, _b;
    const s9 = this.layer, { capabilities: i12, editingInfo: a11, objectIdField: n11, globalIdField: l8, datesInUnknownTimezone: p9, orderBy: u12, parsedUrl: c11 } = s9, d10 = s9.fieldsIndex.toJSON(), m12 = e6(s9), y5 = (_a = s9.timeInfo) == null ? void 0 : _a.toJSON(), f5 = s9.spatialReference.toJSON(), g4 = a(c11);
    let h4 = n11;
...
var c9 = class {
  ...
  createProcessorSchema(e7, t11, o14) {
    const { fields: s9, renderer: i12, geometryType: a11, labelingInfo: n11, labelsVisible: l8, orderBy: p9, objectIdField: d10 } = this.layer, y5 = { fields: s9.map((e8) => e8.toJSON()), renderer: i12 == null ? void 0 : i12.clone(), featureReduction: e4(this.layer, t11), geometryType: a11, labelingInfo: n11, labelsVisible: l8, objectIdField: d10, orderBy: p9 ?? "default" };
...
var p8 = class {
  ...
  async createServiceOptions(e7) {
    var _a;
    const r12 = this.layer, { capabilities: o14, objectIdField: s9 } = r12, i12 = r12.fieldsIndex.toJSON(), n11 = e6(r12), l8 = (_a = r12.timeInfo) == null ? void 0 : _a.toJSON(), a11 = r12.spatialReference.toJSON();
    u9(r12.source);
  ...
  createProcessorSchema(e7, t11, o14) {
    const { fields: s9, renderer: i12, geometryType: n11, labelingInfo: a11, labelsVisible: u12, orderBy: p9, objectIdField: c11 } = this.layer, d10 = { fields: s9.map((e8) => e8.toJSON()), renderer: i12 == null ? void 0 : i12.clone(), featureReduction: e4(this.layer, t11), geometryType: n11, labelingInfo: a11, labelsVisible: u12, objectIdField: c11, orderBy: p9 ?? "default" };
  ...
  getUpdateHashProperties(e7) {
    const t11 = this.layer, { definitionExpression: o14, renderer: s9 } = t11, i12 = this.layer.labelsVisible ? this.layer.labelingInfo : null, n11 = e4(t11, e7), l8 = JSON.stringify(t11.orderBy);
...
var a10 = class {
  ...
  async createServiceOptions(e7) {
    var _a2;
    const t11 = this.layer, { capabilities: o14, objectIdField: s9 } = t11, i12 = t11.fieldsIndex.toJSON(), n11 = e6(t11), l8 = t11.spatialReference.toJSON();
  ...
  createProcessorSchema(r12, t11, o14) {
    const { fields: s9, renderer: i12, geometryType: l8, labelingInfo: a11, labelsVisible: u12, objectIdField: p9 } = this.layer, c11 = { fields: s9.map((e7) => e7.toJSON()), renderer: i12 == null ? void 0 : i12.clone(), featureReduction: e4(this.layer, t11), geometryType: l8, labelingInfo: a11, labelsVisible: u12, objectIdField: p9, orderBy: "default" };
  ...
  getUpdateHashProperties(r12) {
    ...
    return { definitionExpression: o14, renderer: s9, labelingInfo: this.layer.labelsVisible ? this.layer.labelingInfo : null, featureReduction: e4(t11, r12) };
  }
};
...
var u10 = class {
  ...
  async createServiceOptions(r12) {
    var _a;
    const o14 = this.layer, { capabilities: s9, objectIdField: a11 } = o14, i12 = o14.fieldsIndex.toJSON(), l8 = e6(o14), n11 = (_a = o14.timeInfo) == null ? void 0 : _a.toJSON(), u12 = o14.spatialReference.toJSON(), c11 = o14.source.getSource(), p9 = this.layer.objectIdField, d10 = a(s9);
  ...
  createProcessorSchema(e7, t11, o14) {
    const { fields: s9, renderer: a11, geometryType: i12, labelingInfo: n11, labelsVisible: u12, orderBy: c11, objectIdField: p9 } = this.layer, d10 = { fields: s9.map((e8) => e8.toJSON()), renderer: a11 == null ? void 0 : a11.clone(), featureReduction: e4(this.layer, t11), geometryType: i12, labelingInfo: n11, labelsVisible: u12, objectIdField: p9, orderBy: c11 ?? "default" };
    return o9(e7, t11, d10, o14);
  }
  get hasRequiredSupport() {
    return m4(this.layer.renderer);
  ...
  getUpdateHashProperties(e7) {
    ...
    return { apiKey: s9, customParameters: JSON.stringify(t11.customParameters), featureReduction: e4(t11, e7), labelingInfo: a11, orderBy: JSON.stringify(t11.orderBy), renderer: o14 };
  }
};
...
var m10 = class {
  ...
  async createServiceOptions(t11) {
    var _a;
    const s9 = this.layer, { capabilities: i12, objectIdField: l8, globalIdField: n11, orderBy: p9, refreshInterval: u12 } = s9, d10 = s9.fieldsIndex.toJSON(), c11 = e6(s9), m12 = (_a = s9.timeInfo) == null ? void 0 : _a.toJSON(), f5 = s9.spatialReference.toJSON(), y5 = a(this.layer.parsedUrl);
  ...
  createProcessorSchema(e7, r12, o14) {
    const { fields: s9, renderer: i12, geometryType: a11, labelingInfo: l8, labelsVisible: n11, orderBy: p9, objectIdField: u12 } = this.layer, c11 = { fields: s9.map((e8) => e8.toJSON()), renderer: i12 == null ? void 0 : i12.clone(), featureReduction: e4(this.layer, r12), geometryType: a11, labelingInfo: l8, labelsVisible: n11, objectIdField: u12, orderBy: p9 ?? "default" };
  ...
  getUpdateHashProperties(e7) {
    const r12 = this.layer, { definitionExpression: o14, renderer: i12, outFields: a11 } = r12, l8 = this.layer.labelsVisible ? this.layer.labelingInfo : null, n11 = JSON.stringify(r12.customParameters), p9 = e4(r12, e7);
...
var o11 = class {
  ...
  getUpdateHashProperties(r12) {
    const t11 = this.layer, { renderer: l8 } = t11, s9 = this.layer.labelsVisible ? this.layer.labelingInfo : null, i12 = JSON.stringify(t11.customParameters), a11 = e4(t11, r12), o14 = JSON.stringify(t11.orderBy);
    return { outFields: this.layer.outFields, labelingInfo: s9, featureReduction: a11, customParameters: i12, orderBy: o14, renderer: l8 };
  }
  async createServiceOptions(e7) {
    const t11 = e6(this.layer);
  ...
  createProcessorSchema(r12, t11, l8) {
    var _a;
    const s9 = { fields: this.layer.fields.map((e7) => e7.toJSON()), renderer: (_a = this.layer.renderer) == null ? void 0 : _a.clone(), featureReduction: e4(this.layer, t11), geometryType: this.layer.geometryType, labelingInfo: this.layer.labelingInfo, labelsVisible: this.layer.labelsVisible, objectIdField: this.layer.objectIdField, orderBy: this.layer.orderBy };
...
var l7 = class {
  ...
  async createServiceOptions(e7) {
    var _a;
    const r12 = this.layer, { objectIdField: i12 } = r12, n11 = e6(r12), o14 = ((_a = r12.timeInfo) == null ? void 0 : _a.toJSON()) || null, s9 = r12.spatialReference ? r12.spatialReference.toJSON() : null;
  ...
  createProcessorSchema(t11, r12, i12) {
    const { fields: n11, renderer: s9, geometryType: l8, labelingInfo: a11, labelsVisible: c11, objectIdField: d10 } = this.layer, m12 = { fields: n11.map((e7) => e7.toJSON()), renderer: s9 == null ? void 0 : s9.clone(), featureReduction: e4(this.layer, r12), geometryType: l8, labelingInfo: a11, labelsVisible: c11, objectIdField: d10, orderBy: "default" };
  ...
  getUpdateHashProperties(t11) {
    ...
    return { definitionExpression: i12, renderer: n11, labelingInfo: o14, featureReduction: e4(r12, t11), customParameters: s9, geometryDefinition: r12.geometryDefinition, definitionExpressoin: r12.definitionExpression };
  }
};
...
var m11 = class {
  ...
  async createServiceOptions(t11) {
    var _a, _b, _c;
    const r12 = this.layer, { capabilities: i12, datesInUnknownTimezone: a11, editingInfo: l8, globalIdField: p9, objectIdField: u12, refreshInterval: y5, subtypeField: m12 } = r12, c11 = r12.fieldsIndex.toJSON(), d10 = e6(r12), h4 = (_a = r12.timeInfo) == null ? void 0 : _a.toJSON(), f5 = r12.spatialReference.toJSON(), b6 = a(this.layer.parsedUrl), g4 = u12, S2 = !(null != (l8 == null ? void 0 : l8.lastEditDate)) && y5 > 0, F3 = !!has("featurelayer-snapshot-enabled") && "point" === r12.geometryType && (i12 == null ? void 0 : i12.query.supportsPagination) && !(i12 == null ? void 0 : i12.operations.supportsEditing) && !S2, x4 = F3 && t9(t11, r12.fullExtent);
...
var ee2 = class extends _2(i7(j(y2))) {
  constructor() {
    ...
    } }), this._visibilityOverrides = /* @__PURE__ */ new Set(), this._highlightCounter = new e5(), this._lastAvailableFields = [], this._lastTargetState = null, this.eventLog = new l2(), this._sourceRefreshVersion = 1, this._displayRefreshVersion = 1, this._pipelineUpdating = false, this._fields = null, this.featureEffectView = new r6();
  }
  destroy() {
    var _a;
...
//# sourceMappingURL=chunk-46DVS3TQ.js.map
