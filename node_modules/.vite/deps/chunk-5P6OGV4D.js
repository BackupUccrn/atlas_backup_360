...
var u6 = n4 = class extends f {
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-DAFORQCY.js"), o2 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, s4 = await this.portal.request(e2, { query: o2 });
    let l4;
...
var _;
var M2;
var Q = { PortalGroup: () => Promise.resolve({ default: p2 }), PortalItem: () => import("./PortalItem-DAFORQCY.js"), PortalUser: () => Promise.resolve({ default: p5 }) };
var U2 = _ = class extends u3(m2) {
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-5DA6QEOH.js")).default;
...
//# sourceMappingURL=chunk-5P6OGV4D.js.map
